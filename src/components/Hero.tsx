...
const Hero = (props: Props) => {
  return (
    <div
      className=" h-[580px] object-cover bg-repeat-round relative  "
      style={{ backgroundImage: "url('/hero.webp')" }}
    >
      <div className="absolute top-1/4 left-32 max-w-lg">
        <h1 className="text-2xl leading-[44px] tracking-[-0.02em] font-bold lg:text-5xl mt-4 font-work-sans">
